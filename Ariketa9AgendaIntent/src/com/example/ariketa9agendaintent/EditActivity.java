...
public class EditActivity extends Activity implements OnClickListener{
	...
	public void onClick(View v) {
		...
		{
			persona = new Persona(etNombre.getText().toString(), etApellido.getText().toString(), etTelefono.getText().toString(), etObservacion.getText().toString(), sLista.getSelectedItem().toString());
